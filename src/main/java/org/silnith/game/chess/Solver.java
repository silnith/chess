...
public class Solver {
    ...
    public static void main(final String[] args) throws InterruptedException {
        try (final AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(
            ...
            final GameState<ChessMove, Board> initialState = new GameState<ChessMove, Board>(
                    initialMove, initialBoard);
            
            final Searcher<ChessMove, Board> searcher = new Searcher<>(chess,
                    initialState);
            ...
            do {
                ...
                System.out.println("Number of solutions found: "
                        + formatter.format(searcher.getSolutions().size()));
                System.out.println("Maximum tree depth searched: "
                        + formatter.format(searcher.getMaxDepthSearched()));
                System.out.println("Pending nodes to search: "
                        + formatter.format(searcher.getPendingNodesCount()));
                System.out.println("Nodes searched: "
                        + formatter.format(searcher.getNodesSearched()));
                System.out.println();
