...
public class PawnPromotionCaptureMove extends PawnPromotionMove {
	...
	public PawnPromotionCaptureMove(final int sourceRank, final int sourceFile, final int destinationRank, final int destinationFile, final Piece capturingPiece, final Piece capturedPiece, final Type type) {
	...
	public Board apply(final Board board) {
		return board.promotePawn(getSourceRank(), getSourceFile(), getDestinationRank(), getDestinationFile(), new Piece(getType(), getColor()));
	}
