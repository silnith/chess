...
public class PawnPromotionMove implements ChessMove {
	...
	/**
	 * The type of piece to promote the pawn to.
	 * This may be any of {@link Type#ROOK}, {@link Type#KNIGHT},
	 * {@link Type#BISHOP}, or {@link Type#QUEEN}.
	 */
	private final Type type;

	public PawnPromotionMove(final int sourceRank, final int sourceFile, final int destinationRank, final Piece piece, final Type type) {
		super();
